      ...
      <section class="pt-2 pb-lg-4 pb-xl-5 mb-5">
        ...
        <div class="px-2 px-sm-0">
          <div class="swiper swiper-initialized swiper-horizontal swiper-pointer-events" data-swiper-options="{
            ...
            <div class="swiper-wrapper" id="swiper-wrapper-c56b945274a93188" aria-live="polite" style="transition-duration: 0ms; transform: translate3d(-915px, 0px, 0px);"><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate" role="group" aria-label="4 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="3">
            ...
            </div><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate" role="group" aria-label="5 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="4">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              </div><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate" role="group" aria-label="6 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="5">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              </div><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate swiper-slide-prev" role="group" aria-label="7 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="6">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4 swiper-slide-active" role="group" aria-label="1 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="0">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4 swiper-slide-next" role="group" aria-label="2 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="1">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4" role="group" aria-label="3 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="2">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4" role="group" aria-label="4 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="3">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4" role="group" aria-label="5 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="4">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4" role="group" aria-label="6 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="5">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <!-- Item -->
              <div class="swiper-slide h-auto pt-4 swiper-slide-duplicate-prev" role="group" aria-label="7 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="6">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              <div class="swiper-slide h-auto pt-4 swiper-slide-duplicate swiper-slide-duplicate-active" role="group" aria-label="1 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="0">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              </div><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate swiper-slide-duplicate-next" role="group" aria-label="2 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="1">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              </div><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate" role="group" aria-label="3 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="2">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
              ...
              </div><div class="swiper-slide h-auto pt-4 swiper-slide-duplicate" role="group" aria-label="4 / 7" style="width: 342px; margin-right: 24px;" data-swiper-slide-index="3">
                <figure class="d-flex flex-column h-100 px-2 px-sm-0 mb-0">
                  <div class="card h-100 position-relative border-0 shadow-sm pt-4">
                    <span class="btn btn-icon btn-primary shadow-primary pe-none position-absolute top-0 start-0 translate-middle-y ms-4">
                      <i class="bx bxs-quote-left"></i>
            ...
            <!-- Pagination (bullets) -->
            <div class="swiper-pagination position-relative pt-1 pt-sm-3 mt-5 swiper-pagination-clickable swiper-pagination-bullets swiper-pagination-horizontal"><span class="swiper-pagination-bullet swiper-pagination-bullet-active" tabindex="0" role="button" aria-label="Go to slide 1" aria-current="true"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 2"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 3"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 4"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 5"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 6"></span><span class="swiper-pagination-bullet" tabindex="0" role="button" aria-label="Go to slide 7"></span></div>
